...
<body>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">Calificar Producto</div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-4 text-center">
                        <h3 class="mt-4 mb-3">Escribe tu comentario aquí</h3>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <textarea name="puntuacion_desc" id="puntuacion_desc" class="form-control"
                        placeholder="Ingresa tu comentario"></textarea>
                </div>
                <div class="form-group text-center mt-4">
                    <a href="../controlador/Ctrl_Puntuaciones.php">
...
<script>
    ...
    $('#save_review').click(function () {
        ...
        var user_name = $('#usuario_id').val();

        var user_review = $('#puntuacion_descripcion').val();

        if (usuario_id == '' || puntuacion_descripcion == '') {
            alert("Please Fill Both Field");
            return false;
        }
        else {
            $.ajax({
                url: "../controlador/Ctrl_Puntuaciones.php",
                method: "POST",
                data: { rating_data: rating_data, usuario_id: usuario_id, puntuacion_descripcion: puntuacion_descripcion },
